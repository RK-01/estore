...
export const CATEGORY_ADD_PRODUCT_REQUEST = 'CATEGORY_ADD_PRODUCT_REQUEST';
export const CATEGORY_ADD_PRODUCT_SUCCESS = 'CATEGORY_ADD_PRODUCT_SUCCESS';
export const CATEGORY_ADD_PRODUCT_FAIL = 'CATEGORY_ADD_PRODUCT_FAIL';
export const CATEGORY_ADD_PRODUCT_RESET = 'CATEGORY_ADD_PRODUCT_RESET';
