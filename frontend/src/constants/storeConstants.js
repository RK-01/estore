...
export const STORE_OWNER_DETAILS_REQUEST = 'STORE_OWNER_DETAILS_REQUEST';
export const STORE_OWNER_DETAILS_SUCCESS = 'STORE_OWNER_DETAILS_SUCCESS';
export const STORE_OWNER_DETAILS_FAIL = 'STORE_OWNER_DETAILS_FAIL';
...
export const STORE_STATUS_REQUEST = 'STORE_STATUS_REQUEST';
export const STORE_STATUS_SUCCESS = 'STORE_STATUS_SUCCESS';
export const STORE_STATUS_FAIL = 'STORE_STATUS_FAIL';
